...
**Важно**: Для всех текстов, адресованных пациенту, соблюдать речевой стиль "Точки опоры" — живой язык без канцелярита. Полный справочник: `prompts/language-style.md`.
