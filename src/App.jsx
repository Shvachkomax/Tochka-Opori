...
${doctor.replace(/===DOCTOR_REPORT===/g, "").trim().split("\n").map(l => `<p>${l}</p>`).join("\n")}
  ...
  const adminModuleRoute = typeof window !== "undefined"
    ? window.location.pathname === "/admin/body" ? "body" : "support"
    : "support";
        ...
        <main style={s.grid} className="app-grid">
          <section>
            ...
            <p style={{ color: "#B85C4A", fontSize: 12, marginTop: 8, lineHeight: 1.4 }}>
              Если у вас острая боль, высокая температура, кровотечение или другие неотложные состояния — звоните 103 или 112.
            </p>
            )}
          </section>
