...
### Body v0.2 — дневник дня
Поля для ежедневного заполнения:
- вес;
- шаги;
- тренировка;
- питание кратко;
- вода;
- сон;
- тяга к сладкому/переедание;
- энергия 1-10;
- комментарий.

### Body v0.3 — уточнение физической активности
Вопросы после первого разбора:
- сколько силовых тренировок в неделю;
- сколько кардио;
- сколько ходьбы;
- есть ли боль/ограничения;
- что реально готов делать 7 дней.

### Body v0.4 — учёт питания и калорий
Вопросы:
- ведёт ли пользователь учёт калорий;
- каким приложением пользуется;
- готов ли 3 дня записывать питание;
- есть ли кухонные весы;
- что сложнее всего считать;
- хочет ли мягкий учёт без жёстких ограничений.

### Body v0.5 — голосовой дневник
Голос появляется не в первичной анкете, а в дневнике.
Пример:
«Сегодня прошёл 7000 шагов, тренировку не сделал, ел три раза, вечером тянуло на сладкое, спал плохо».
AI разбирает это в структуру: steps, workout, meals, cravings, sleep, mood/energy, notes.
